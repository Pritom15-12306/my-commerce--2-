                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <p class="category"><i class="lni lni-tag"></i> Product Category:<a
                                    href="javascript:void(0)">{{ $product->category->name }}</a></p>
                            <p class="category"><i class="lni lni-tag"></i> Product Sub Category:<a
                                    href="javascript:void(0)">{{ $product->subCategory->name }}</a></p>
                            <p class="category"><i class="lni lni-tag"></i> Product Brand:<a
